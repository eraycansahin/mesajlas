package com.berkancalikoglu.mesajlas;
...
public class MainActivity extends AppCompatActivity {
    ...
    /*private void initChatbot() {
        final AIConfiguration config = new AIConfiguration("032d9af645ac46739a1b2d576d5ff224",
    ...
    private void initV2Chatbot() {
        try {
            InputStream stream = getResources().openRawResource(R.raw.eglencelimesaj);
